...
# Filtra os dados para o jogador 'Yuri Alberto'
jogador_yuri_alberto = 'Yuri Alberto'
df_yuri_alberto = df_merged[df_merged['JOGADOR'] == jogador_yuri_alberto]

# Agrupa os dados por adversário e calcula a contagem de gols correta
contagem_gols_por_adversario = df_yuri_alberto.groupby('VISITANTE').size().reset_index(name='Total de Gols')
...
plt.title('Total de Gols Marcados por Yuri')
